#### Just taking this from the TF tutorial to keep it simple and reducing chance for mistakes
...
class Encoder(tf.keras.layers.Layer):
    def __init__(
        ...
        self.embedding = tf.keras.layers.Dense(self.d_model, activation="tanh")
